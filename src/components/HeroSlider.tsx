              ...
              <div className="container mx-auto px-4 md:px-8 py-20 md:py-32 relative h-full flex items-center justify-end text-right">
                <div className="max-w-3xl text-white">
                  ...
                  <div className="flex flex-col sm:flex-row justify-end gap-3 sm:gap-4">
                    <Link to="/lien-he">
                      <button className="w-full sm:w-auto bg-white hover:bg-[#0bce80] border-none px-5 sm:px-6 py-2 rounded-3xl text-[#0bce80] text-base sm:text-lg font-medium hover:text-white flex items-center justify-center gap-2 transition-all duration-300">
                        Yêu cầu tư vấn <ArrowRightOutlined />
                      </button>
                    </Link>
                    <Link to="/gioi-thieu">
                      <button className="w-full sm:w-auto bg-[#0bce80] hover:bg-black border-none px-5 sm:px-6 py-2 rounded-3xl text-white hover:text-[#0bce80] text-base sm:text-lg font-medium flex items-center justify-center gap-2 transition-all duration-300">
                        Tìm hiểu thêm
                      </button>
                    </Link>
                  </div>
